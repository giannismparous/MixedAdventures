...
public class GoombaMove : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        moveSpeed = 3f;
        colliderTimer = 0;
        Physics2D.IgnoreCollision(GameObject.Find("Player").transform.Find("Body").GetComponent<Collider2D>(), transform.parent.transform.Find("Feet").GetComponent<Collider2D>(),true);
    }
